const { SET_CONTEXT, ADD_SONG, CHANGE_PATH, CHANGE_CURRENT_SONG_INDEX, SET_CURRENT_TRACK_TIME, DISABLE_SONG_SELECT, ENABLE_SONG_SELECT, SET_PAUSED, CHANGE_VOLUME, SET_CURRENT_TRACK_DURATION, ADD_SONG_DURATION, HIDE_SPINNER } = require("./types");
...
export function addSongDuration(songIndex) {
  return {
    type: ADD_SONG_DURATION,
    payload: songIndex
  }
}
